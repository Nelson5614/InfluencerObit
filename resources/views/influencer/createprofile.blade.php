            ...
            <form class="space-y-6" action="{{ route('profiles.store') }}" method="POST" enctype="multipart/form-data" >
                ...
                <div class="grid md:grid-cols-2 md:gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="location" id="location" class="pl-4 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <button type="submit" class="bg-primary p-4 text-white rounded-md">Create Profile</button>
            </form>
        </div>
    </div>
</div>
