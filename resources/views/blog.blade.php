...
<div>
    ...
    <div class=" flex md:flex-row flex-col px-28 pt-28 ">

        <div>
            <span class="md:text-3xl text-2xl font-bold text-gray-700 py-6" >Latest News On Influencer Marketing</span>
            <p class="text-gray-700 mt-10">Explore our latest news when it comes to influencer marketing and trending topics on influencer obit, explore our articles on various topics on how to user productively use influencer obit</p>


        </div>
        <img src="{{ asset('assets/images/head.png') }}" alt="">
    </div>
</div>
