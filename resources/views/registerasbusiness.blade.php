        ...
        <div class="container flex items-center justify-center min-h-screen">
          <div class="">
            <div class="w-full px-4">
              <div
                class="wow fadeInUp relative mx-auto  overflow-hidden rounded-xl shadow-form bg-white dark:bg-dark-2 py-14 px-8 text-center sm:px-12 md:px-[60px]"
                data-wow-delay=".15s">
                <div class="mb-10 text-center">
                  <a href="javascript:void(0)" class="mx-auto inline-block max-w-[160px]">

                     <img class="rounded-md w-28" src="{{ asset('assets/images/logo/logo1.png') }}" />
