...
@section('content')
        ...
        <div class=" flex md:flex-row flex-col items-center justify-center mx-auto mt-10  md:px-12">
            ...
            <div class="md:w-1/2 px-14">
                ...
                <div class=" flex items-center space-x-2">
                    ...
                    <span class="text-gray-800" >Unlock the magic of influecer marketing</span>
                </div>
                <div>
                    <h1 class="font-bold  text-3xl py-6 leading-2 text-gray-600">Find The Right
    ...
    <section class="py-10 bg-gray-100">
        ...
        <div class="flex md:flex-row flex-col items-center justify-between space-y-6 px-20">
            <div class="">
                ...
                <span class="font-bold text-gray-600 ">Connect With Influcers</span>
            </div>
            <div>
                <img src="{{ asset('assets/images/icons/workshop.png') }}" class="w-40" alt="" srcset="">
                <span class="font-bold text-gray-600">Meet To Influencers</span>
            </div>
            <div class="">
                <img src="{{ asset('assets/images/icons/salary.png') }}" class="w-40" alt="" srcset="">
                <span class="font-bold text-gray-600">Make Money</span>
            </div>
        </div>
    </section>
    ...
    <section class="py-8 px-14 mt-12">
        ...
        <div class="flex md:flex-row flex-col mt-10 justify-center items-center gap-14">
            <div class="md:w-1/2">
                <img src="{{ asset('assets/images/head_img.png') }}" alt="" srcset="">
            </div>
            <div class="md:w-1/2">
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div class="w-96">
                        <span class="font-bold text-gray-600">Influencer Who Already On Your Nich!</span>
                    </div>
                </div>
                <div class="ml-11">
                ...
                <div class="flex gap-4 items-center mt-8">
                    ...
                    <div class="w-96">
                        <span class=" font-bold text-gray-600">Not Just Influencer, Right One For Your Business!</span>
                    </div>
                </div>
                <div class="ml-11">
                ...
                <div class="flex gap-4 mt-8 items-center">
                    ...
                    <div class="w-96">
                        <span class=" font-bold text-gray-600">Data Driven Decisions!</span>
                    </div>
                </div>
                <div class="ml-11">
        ...
        <div class="flex md:flex-row flex-col justify-center items-center gap-14">
            ...
            <div class="md:w-1/2">
                ...
                <div class="flex gap-4 items-center">
                    ...
                    <div class="w-96">
                        <span class="font-bold text-gray-600">Our Powerful Influencer Manager Tool!</span>
                    </div>
                </div>
                <div class="ml-11">
                    <p>
                ...
                <div class="flex gap-4 items-center mt-8">
                    ...
                    <div class="w-96">
                        <span class=" font-bold text-gray-600">Hire Top Notch Influencers Easily and Quickly</span>
                    </div>
                </div>
                <div class="ml-11">
            ...
            <div class="md:w-1/2">
                <img src="{{ asset('assets/images/home (1).png') }}" class="rounded-md h-96" alt="" srcset="">
            </div>
        </div>
    </section>
    ...
    <section class="py-8 mt-20 px-14 w-full bg-gray-100">
        <div class="text-center">
            <span class="font-bold text-3xl text-gray-600">What Are Others Saying?</span>
        </div>
        <div class="flex md:flex-row flex-col items-center justify-between">
            ...
            <div class="bg-white w-96 shadow-md py-5 mt-8 rounded-md">
                ...
                <div class="pb-8 px-8">
                    <span class="font-bold text-gray-600">Limako Sebeta</span><br/>
