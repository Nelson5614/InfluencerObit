    ...
    <div class=" flex md:flex-row flex-col items-center justify-center mx-auto mt-10  md:px-12">
        ...
        <div class="md:w-1/2 px-14 md:ml-28">
            ...
            <div class=" flex items-center space-x-2">
                ...
                <span class="text-white" >Analyse Your Perfomance</span>
            </div>
            <div>
                <h1 class="font-bold  text-3xl py-6 leading-2 text-white ">Analyze
                    <span class="text-primary">Influecer</span>
                     Progress!</h1>
            </div>
            <div>
                <p class="text-white">Monitor the influencer progress and perfomance and decide whether to continue work relatioship or not</p>
            </div>
            <div class="py-6 ">
